...
class EvaluationCreateRequest(BaseModel):
    ...
    prompt_id: PyObjectId = Field(..., description="The ID of the prompt to use for evaluation.")
    test_set_data: List[EvaluationRequestData] = Field(..., min_items=1, description="List of source texts and optional references.")
    # Future: model_id: Optional[PyObjectId] = None # If supporting multiple models
...
class EvaluationBase(BaseModel):
    ...
    prompt_id: PyObjectId = Field(..., description="ID of the prompt used.")
    ...
    # Future: model_id: Optional[PyObjectId] = None
